...
class DataTransformation:
    ...
    def initiate_data_transformation(self) -> DataTransformationArtifact:
        ...
        try:
            ...
            # 🔥 CRITICAL FIX: Align train and test columns after dummy creation
            logging.info("Aligning train and test dataframe columns")
            ...
            logging.info("Train and test columns aligned successfully")
